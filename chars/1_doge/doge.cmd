...
type = changestate
value = 4100
triggerall = palno = [2,12]
triggerall = command = "超 木吉之鬼步"
triggerall = statetype != A
triggerall = power >=1000
trigger1 = ctrl
...
;------------------------------------------------------------------------------
;deep dark fantasy
[state -1, deep dark fantasy]
type = changestate
value = 4700
triggerall = palno = [6,12]
triggerall = command = "deep dark fantasy"
...
type = changestate
value = 7500
triggerall = command = "爆热 狗头finger"
triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl
...
type = changestate
value = 7200
triggerall = palno = [4,12]
triggerall = command = "大抱歉术"
triggerall = power >= 3000
trigger1 = statetype != A
trigger1 = ctrl

;ROAD ROLLER哒
[state -1,ROAD ROLLER哒]
type = changestate
value = 4840
triggerall = command = "ROAD ROLLER哒"
;triggerall = power >= 1000
trigger1 = statetype != A
trigger1 = ctrl
...
type = ChangeState
value = 800
triggerall = palno = [5,12]
triggerall = power >= 1000
trigger1 = command = "OPEN GET"
