...
;----------------------------------------------
[Command]
name = "Max Hiougi Tenha Fujin Zan"
...
;----------------------------------------------
[Command]
name="Max Tenha Danku Retsu Zan"
...
;---------------------------------------------
[Command]
name="Raging Ougi Senpu Retsu Zan"
...
;----------------------------------------------
[Command]
name="Max Raging Ougi Senpu Retsu Zan"
...
;----------------------------------------------
[Command]
name="Max Martelo de Guerra Hades"
...
;----------------------------------------------
[Command]
name="Omega Ougi Senpu Retsu Zan"
...
time = 5
;--------------------------------------------------------------------
[State -1, Omega Ougi Senpu Retsu Zan]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Omega Ougi Senpu Retsu Zan"
...
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Tenha Seiou Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)

;----------------------------------------------------------------------
[State -1, Max Martelo de Guerra Hades]
type=ChangeState
value=3550
triggerall=!AILevel && RoundState=2 && (stateno!=[3450,3453]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Martelo de Guerra Hades"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Martelo de Guerra Hades]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && (stateno!=[3400,3403]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Martelo de Guerra Hades"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)

;----------------------------------------------------------------------
[State -1, Max Tenha Danku Retsu Zan]
type=ChangeState
value=3450
triggerall=!AILevel && RoundState=2 && (stateno!=[3450,3453]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Tenha Danku Retsu Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Tenha Danku Retsu Zan]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && (stateno!=[3400,3403]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Tenha Danku Retsu Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Raging Ougi Senpu Retsu Zan]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Raging Ougi Senpu Retsu Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Raging Ougi Senpu Retsu Zan]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3101]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Raging Ougi Senpu Retsu Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Hiougi Tenha Fujin Zan]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Hiougi Tenha Fujin Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Hiougi Tenha Fujin Zan]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Hiougi Tenha Fujin Zan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;------------------------------------------------------------------------
[State -1, EX Sake Kougeki]
type = ChangeState
value = 1450
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Sake Kougeki" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
[State -1, Sake Kougeki]
type=changestate
value=1400
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Sake Kougeki"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;========================================================================
[State -1, EX Ougi Dragon Tooth]
type = ChangeState
value = 1350
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Ougi Dragon Tooth" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
[State -1, Ougi Dragon Tooth]
type=changestate
value=1300
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Ougi Dragon Tooth"
trigger1= ctrl 
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
...
value = 1250
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Ougi Resshin Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
...
value = 1200
triggerall =  !AILevel && roundstate=2 && statetype!=A
triggerall = command = "Ougi Resshin Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
[State -1, EX Ougi Senpu Retsu Zan]
type = ChangeState
value = 1050
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500&& !numhelper(1055)
triggerall = command = "EX Ougi Senpu Retsu Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, Ougi Senpu Retsu Zan]
type = ChangeState
value = 1000
triggerall =  !AILevel && roundstate=2 && statetype!=A
triggerall = command = "Ougi Senpu Retsu Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, Zero Counter P]
type = changestate
value = 750
trigger1 = !AIlevel
trigger1 = stateno = 150 || stateno = 152
trigger1 = command = "Counter_P" 
trigger1 = roundstate = 2 && !var(20) && power >= 1000 && statetype != A

[State -1, Zero Counter K]
type = changestate
value = 751
trigger1 = !AIlevel
trigger1 = stateno = 150 || stateno = 152
trigger1 = command = "Counter_K" 
trigger1 = roundstate = 2 && !var(20) && power >= 1000 && statetype != A
;------------------------------------------------------------------------
[State -1, Throw 1]
type = ChangeState
...
triggerall =!AILevel&&Roundstate=2&&statetype != A&&stateno != 100
trigger1 = ctrl
;------------------------------------------------------------------------
[State -1, Throw 2]
type = ChangeState
...
trigger1 = ctrl || StateNo = 52 || (StateNo = [100,650])
trigger1 = !var(41)
;--------------------------------------------------------------------------
...
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=stateno=240&&movecontact&&var(55)
trigger4=stateno=230&&movecontact&&var(55)
trigger5=stateno=220&&movecontact&&var(55)
trigger6=stateno=210&&movecontact&&var(55)
trigger7=stateno=200&&movecontact&&var(55)
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
[State -1, MAX Martelo de Guerra Hades AI]
type=ChangeState
value=3550
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3450,3453]) && StateType != A &&var(20)<=60&& power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
...
;-------------------------------------------------------------------------
[State -1, Martelo de Guerra Hades AI]
type=ChangeState
value=3500
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3400,3403]) && StateType != A &&var(20)<=60&& power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
trigger1=ctrl || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1, Omega Ougi Senpu Retsu Zan AI]
type=changestate
value=3300
...
triggerall=(p2stateno != [150, 155]) && (enemynear,statetype != L) && !(enemynear, hitfall)&&(enemynear,stateno!=[5100,5220]) && (P2dist x=[30,140])&&(P2dist y=[-80,5]) &&(enemynear, statetype != A)&&(enemynear, statetype != C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=var(6)&&enemynear,movetype=H&&random<400
trigger3=(stateno=[200,450]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Max Tenha Danku Retsu Zan AI]
type=ChangeState
value=3450
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3450,3453]) && StateType != A &&var(20)<=60&& power >= 2000 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
...
trigger3=(var(7)) && movehit && random<50
;-------------------------------------------------------------------------
[State -1, Tenha Danku Retsu Zan AI]
type=ChangeState
value=3400
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3400,3403]) && StateType != A &&var(20)<=60&& power >= 1000 && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,80]) && (p2bodydist y =[-80,5]) &&(enemynear, statetype =S)
...
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1, Max Raging Ougi Senpu Retsu Zan AI]
type=ChangeState
value=3150
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3150,3151])&& StateType != A && var(20) <= 60 && power >= 2000 && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=40) && (p2bodydist y =[-90,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
trigger3=(var(7)) && movehit && random<50
;------------------------------------------------------------------------
[State -1, Raging Ougi Senpu Retsu Zan AI]
type=ChangeState
value=3100
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3100,3101]) && StateType != A &&var(20) <= 60 && power >= 1000 && random < (80 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) &&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x >=10) && (p2bodydist y =[-90,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
trigger3=(var(7)) && movehit && random<50
;---------------------------------------------------------------------------
[State -1, Hiougi Tenha Fujin Zan AI]
type=ChangeState
value=3050
triggerall=AILevel && RoundState=2 && numenemy && StateType != A &&(stateno!=[3000,3002])&& var(20)<=0 && power >= 2000
triggerall=(p2bodydist x=[20,90]) && (p2bodydist y = [ -110, 5]) && random < (150 * (AIlevel ** 2 / 64.0))
...
trigger3=(stateno=[200,450]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Sake Kougeki AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 100), 1450, 1400)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[30,200]) && (p2bodydist y = [ -80, 5])&& enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5100,5220]) && !Numtarget(1350) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (50 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Ougi Dragon Tooth AI]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && (P2BodyDist x = [0,145]), 1350, 1300)
...
trigger2 = var(5) && MoveContact && Random < (100 * (AILevel ** 2 / 64.0))
trigger3 = (stateno = [200, 250]) && (movehit = [1, 16]) && random < (150 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
[State -1, Ougi Resshin Zan AI]
type = changestate
...
trigger2 = var(5) && (movecontact || var(18)) && random < (50 * (AIlevel ** 2 / 64.0))
trigger3=(stateno=[200,450]) && movehit && random < (550 * (AIlevel ** 2 / 64.0))
;---------------------------------------------------------------------------
