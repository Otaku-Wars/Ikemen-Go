...
[State -1, Sacred Howling]
type = ChangeState
value = 3400
triggerall = !var(58)||(var(58)&&sysfvar(4)=0)
triggerall = command = "SacredHowling" 
triggerall = RoundState = 2 && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0))
triggerall = (power >= 3000 && var(20) <= 0 && var(53)<=0 && var(54)!=2) || (power >= 1000 && var(53) > 0) || (var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Air Strike the Blood]
type = ChangeState
value = 3300
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "StrikeTheBlood"
...
[State -1, MAX Howl of the Wolf]
type = ChangeState
value = 3550
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !var(39) || var(8)
triggerAll = !AILevel
triggerAll = command = "MaxDefend"
triggerAll = RoundState = 2 && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0))
triggerAll = (power >= 2000 && var(20) <= 60 && var(53)<=0 && var(54)!=2) || (power >= 500 && var(53) > 0) || (var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8) && var(22) < 1 && Ifelse(StateNo = 3500, AnimElemTime(7) > 18, 1)

[State -1, MAX Super Heavy Strike]
type = ChangeState
value = 3150
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "MaxS-WildStrike"
triggerAll = RoundState = 2 && (StateType = A && ((StateNo != 1210 && StateNo != 1260) | ((StateNo = 1210 | StateNo = 1260) && Pos Y < 0 && AnimElem = 3, >= 0)))
triggerAll = (power >= 2000 && var(20) <= 60 && var(53)<=0 && var(54)!=2) || (power >= 500 && var(53) > 0) || (var(42) > 0)
triggerAll = (var(3) != [1,2])
trigger1 = ctrl && pos y <= -40
trigger2 = var(7) || var(8) && var(22) < 1 && Ifelse(StateNo = 3500, AnimElemTime(7) > 18, 1)

[State -1, MAX Super Wild Strike]
type = ChangeState
value = 3050
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
...
[State -1, Howl of the Wolf]
type = ChangeState
value = 3500
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !var(39) || var(8)
triggerAll = !AILevel
triggerAll = command = "Defend"
triggerAll = RoundState = 2 && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0))
triggerAll = (power >= 1000 && var(20) <= 60 && var(53)<=0 && var(54)!=2) || (var(53) > 0) || (var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || (var(8) && var(22) < 2 && StateNo != 3500)

[State -1, Super Heavy Strike]
type = ChangeState
value = 3100
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "S-WildStrike"
triggerAll = RoundState = 2 && (StateType = A && ((StateNo != 1210 && StateNo != 1260) | ((StateNo = 1210 | StateNo = 1260) && Pos Y < 0 && AnimElem = 3, >= 0)))
triggerAll = (power >= 1000 && var(20) <= 60 && var(53)<=0 && var(54)!=2) || (var(53) > 0) || (var(42) > 0)
triggerAll = (var(3) != [1,2])
trigger1 = ctrl && pos y <= -40
trigger2 = var(7) || (var(8) && var(22) < 2 && StateNo != 3100) && Ifelse(StateNo = 3500, AnimElemTime(7) > 18, 1)

[State -1, Super Wild Strike]
type = ChangeState
value = 3000
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
...
triggerAll = (power >= 1000 && var(20) <= 60 && var(53)<=0 && var(54)!=2) || (var(53) > 0) || (var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || (var(8) && var(22) < 2 && StateNo != 3000) && Ifelse(StateNo = 3500, AnimElemTime(7) > 18, 1)
...
[State -1, EX Young Thunder]
type = ChangeState
value = 1350
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "EXYoungThunder"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 500 && var(20) <= 60 && var(54) != 2) || var(53) > 0 || (power >= 500 && var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Heavy Strike]
type = ChangeState
value = 1450
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "EXWildStrike"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (power >= 500 && var(20) <= 60 && var(54) != 2) || var(53) > 0 || (power >= 500 && var(42) > 0)
triggerAll = (var(3) != [1,2])
trigger1 = ctrl
...
[State -1, EX Arrow Strike]
type = ChangeState
value = 1150
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "EXArrowStrike"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 500 && var(20) <= 60 && var(54) != 2) || var(53) > 0 || (power >= 500 && var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Twin Strike]
type = ChangeState
value = 1250
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "EXTwinStrike" && command != "holddown" && command != "holdback"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 500 && var(20) <= 60 && var(54) != 2) || var(53) > 0 || (power >= 500 && var(42) > 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || StateNo = 100
trigger2 = var(6)

[State -1, Young Thunder]
type = ChangeState
value = 1300
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "YoungThunder"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Arrow Strike]
type = ChangeState
value = 1100
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = !AILevel
triggerAll = command = "ArrowStrike"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "TwinStrike" && command != "holddown" && command != "holdback"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || StateNo = 100
trigger2 = var(6)
...
[State -1, Wild Strike]
type = ChangeState
value = ifElse(((var(53) <= 0 && Power >= 500 && var(54) != 2) || (var(53) > 0) || (var(42) > 0 && Power >= 500)) && (P2BodyDist x = [0,145]) && var(20) <= 60, 1050, 1000)
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Twin Strike]
type = ChangeState
value = ifElse(((var(53) <= 0 && Power >= 500 && var(54) != 2) || (var(53) > 0) || (var(42) > 0 && Power >= 500)) && Random < 10 && var(20) <= 600, 1250, 1200)
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
[State -1, Heavy Strike]
type = ChangeState
value = ifElse(((var(53) <= 0 && Power >= 500 && var(54) != 2) || (var(53) > 0) || (var(42) > 0 && Power >= 500)) && Random < 500 && var(20) <= 60, 1450, 1400)
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType = A
triggerAll = var(3) != [1,2]
...
[State -1, Arrow Strike]
type = ChangeState
value = ifElse(((var(53) <= 0 && Power >= 500 && var(54) != 2) || (var(53) > 0) || (var(42) > 0 && Power >= 500)) && Random < 100 && var(20) <= 60, 1150, 1100)
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
value=3400
triggerall = !var(58)||(var(58)&&sysfvar(4)=0)
triggerall = AILevel && numenemy && RoundState=2 && (stateno!=[3200,3299]) && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0))
...
value = 3550
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy && !var(39)
triggerAll = RoundState = 2 && StateType != A && StateNo!= 3550
...
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy && !var(39)
triggerAll = RoundState = 2 && StateType != A && StateNo!= 3500
...
[State -1, MAX S. Wild Strike]
type = ChangeState
value = 3050
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0)) && (StateNo!= [3050,3060])
triggerAll = ((var(53) <= 0 && Power >= 2000 && var(20) <= 60 && var(54) != 2) || (var(53) > 0 && Power >= 500) || (var(42) > 0))
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-140,140]) && (P2Dist y = [-32,32])
...
[State -1, S. Heavy Strike]
type=ChangeState
value=Ifelse(((var(53) <= 0 && Power >= 2000 && var(20) <= 60 && var(54) != 2) || (var(53) > 0 && Power >= 500) || (var(42) > 0))&&random<=500,3150,3100)
triggerAll=!var(58)||(var(58)&&sysfvar(4)=0)
triggerAll=AILevel && numenemy && RoundState=2 && stateno!= 3100 && random < (220 * (var(59) ** 2 / 64.0))
triggerAll=((var(53) <= 0 && Power >= 1000 && var(20) <= 60 && var(54) != 2) || (var(53) > 0) || (var(42) > 0))
triggerAll=(StateType = A && ((StateNo != 1210 && StateNo != 1260) | ((StateNo = 1210 | StateNo = 1260) && Pos Y < 0 && AnimElem = 3, >= 0)))
...
[State -1, S. Wild Strike]
type = ChangeState
value = 3000
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && (StateType != A | ((StateNo = 1210 | StateNo = 1260) && Pos Y >= 0 && AnimElem = 3, < 0)) && StateNo!= 3000
triggerAll = ((var(53) <= 0 && Power >= 1000 && var(20) <= 60 && var(54) != 2) || (var(53) > 0) || (var(42) > 0))
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-100,100]) && (P2Dist y = [-32,32])
...
value=3200
triggerAll = !var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A &&var(20)<=0 && power >= 1000 && random < (400 * (var(59) ** 2 / 64.0))
