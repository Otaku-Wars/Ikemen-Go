...
Website:	-
Customized version of Gakuto Mikumo's Yukina character, for MUGEN 1.0
...
.Wild Strike (EX)		        	D, DF, F, p
  .Pull In					 => p                               (after hit/guard)
.Heavy Strike (EX)                  D, DF, F, p                         (Air)
.Young Thunder (EX)                 F, D, DF, p
.Twin Strike (EX)                   F, F, p
.Arrow Strike (EX)                  D, DB, B, p
  .Forward Charge                    => x
  .Descending Rush                   => y / z                           (after hit/guard or whiff)
...
.Wild Strike (MAX)                  D, DF, F, D, DF, F, p
.Heavy Strike (MAX)                 D, DF, F, D, DF, F, p               (Air)
.Howl of the Wolf (MAX)             D, DB, B, D, DB, B, p

 <Lv3 Super>

.Strike the Blood                   D, DF, F, D, DF, F, pk / 3p         (Air also)
.Sacred Howling                     D, DB, B, D, DB, B, pk / 3p
...
RAGE EXPLOSION:
 ...
 - All supers can be performed at no power cost, And save the Rage Meter according to the level of the supers
...
=====<Disclaimer>=====
 ...
 - Yukina Himeragi is property of Gakuto Mikumo.
 - Strike the Blood is property of Gakuto Mikumo.
