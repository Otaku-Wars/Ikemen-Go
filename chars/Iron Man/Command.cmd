...
[State -1, Heavy Artillery UniBeam]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "HeavyArtilleryUniBeam"
...
[State -1, MAX Rocket Launchers]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXRocketLaunchers"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Proton Cannon]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXProtonCannon"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Nano Assault]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXNanoAssault"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Rocket Launchers]
type = ChangeState
value = 3300
triggerAll = !AILevel
triggerAll = command = "RocketLaunchers"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, Nano Assault]
type = ChangeState
value = 3100
triggerAll = !AILevel
triggerAll = command = "NanoAssault"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Mini Misils]
type = ChangeState
value = 1830
triggerAll = !AILevel
triggerAll = command = "EXMiniMisils"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, EX Repulsor Burst]
type = ChangeState
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXRepulsorShot"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, EX Beam Shot]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXBeamShot"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Repulsor Shot]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXRepulsorShot"
...
[State -1, EX Shoulder Misil]
type = ChangeState
value = 1730
triggerAll = !AILevel
triggerAll = command = "EXFly"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Repulsor Blast]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXRepulsorBlast"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Air Smart Bomb]
type = ChangeState
value = 1180
triggerAll = !AILevel
triggerAll = command = "EXSmartBomb"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Air Unibeam]
type = ChangeState
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXUnibeam"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
value = 1800
triggerAll = !AILevel
triggerAll = command = "MiniMisils"
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Repulsor Burst]
type = ChangeState
value = 1600
triggerAll = !AILevel
triggerAll = command = "RepulsorShot"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3 = Stateno = 1310
...
value = 1500
triggerAll = !AILevel
triggerAll = command = "BeamShot"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Repulsor Shot]
type = ChangeState
value = 1400
triggerAll = !AILevel
triggerAll = command = "RepulsorShot"
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "RepulsorBlast"
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Smart Bomb]
type = ChangeState
value = 1150
triggerAll = !AILevel
triggerAll = command = "SmartBomb"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Mini Misils]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100, 1830, 1800)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
