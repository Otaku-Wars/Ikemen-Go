...
value = 3200
triggerAll = !AILevel
triggerAll = command = "VenomBash"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Death Bite]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXDeathBite"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Tendrils Barrage]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXTendrilsBarrage"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Venom Web]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXVenomWeb"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "DeathBite"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Tendrils Barrage]
type = ChangeState
value = 3300 
triggerAll = !AILevel
triggerAll = command = "TendrilsBarrage"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "VenomWeb"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Power Stone]
type = ChangeState
value = 1730
triggerAll = !AILevel
triggerAll = command = "EXPowerStone"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Venom Glide]
type = ChangeState
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXVenomGlide"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXWebThrow"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Venom Trap]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXVenomTrap"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerall = !Numhelper(1401)
triggerall = !Numhelper(1402)
triggerall = !Numhelper(1403)
triggerall = !Numhelper(1404)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXTendril"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Air Venom Barrell]
type = ChangeState
value = 1280
triggerAll = !AILevel
triggerAll = command = "EXVenomBarrell"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Venom Barrell]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXVenomBarrell"
...
[State -1, EX Venom Rush]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXVenomRush"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Air Venom Fang]
type = ChangeState
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXVenomFang"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Venom Fang]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXVenomFang"
...
value = 1300
triggerAll = !AILevel
triggerAll = command = "Tendril"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Venom Barrell]
type = ChangeState
value = 1250
triggerAll = !AILevel
triggerAll = command = "VenomBarrell"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Venom Barrell]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "VenomBarrell"
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "VenomRush"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Venom Fang]
type = ChangeState
value = 1050
triggerAll = !AILevel
triggerAll = command = "VenomFang"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Air Venom Barrel]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133, 1280, 1250)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
...
[State -1, Air Venom Fang]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133, 1080, 1050)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
