...
[State -1, Demon Transform]
type = ChangeState
value = 3100
triggerall = !AIlevel
triggerall = command = "Demon Transform"
...
trigger15 = stateno = 1000 && movecontact
...
value = 3035
triggerall = !AIlevel
triggerall = command = "Tokijin! Max"
triggerall = RoundState = 2 && StateType != A
...
trigger18 = stateno   = 1130 && movecontact
trigger19 = stateno   = 1200 && movecontact
trigger20 = stateno   = 1230 && movecontact
trigger21 = stateno   = 3000 && movecontact
trigger22 = stateno   = 3010 && movecontact
trigger23 = stateno   = 3020 && movecontact
trigger24 = stateno   = 3030 && movecontact

[State -1, Tokijin!]
type = ChangeState
value = 3030
triggerall = !AIlevel
triggerall = command = "Tokijin!"
triggerall = RoundState = 2 && StateType != A
...
[State -1, Dragon Strike Max]
type = ChangeState
value = 3025
triggerall = !AIlevel
triggerall = command = "Dragon Strike Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6) || var(7)
...
[State -1, Dragon Strike]
type = ChangeState
value = 3020
triggerall = !AIlevel
triggerall = command = "Dragon Strike"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1  = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2  = var(6)
...
trigger21 = stateno   = 3000 && movecontact
trigger22 = stateno   = 3010 && movecontact
trigger23 = stateno   = 3030 && movecontact

;---------------------------------------------------------------------------------------------------------------------

[State -1, Whip of Light! Max]
type = ChangeState
value = 3015
triggerall = !AIlevel
triggerall = command = "Whip of Light! Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6) || var(7)
...
value = 3010
triggerall = !AIlevel
triggerall = command = "Whip of Light!"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1  = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2  = var(6)
...
trigger20 = stateno   = 1230 && movecontact
trigger21 = stateno   = 3000 && movecontact
trigger22 = stateno   = 3020 && movecontact
trigger23 = stateno   = 3030 && movecontact

;---------------------------------------------------------------------------------------------------------------------

[State -1, Poison Claw! Max]
type = ChangeState
value = 3005
triggerall = !AIlevel
triggerall = command = "Poison Claw! Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6) || var(7)
...
value = 3000
triggerall = !AIlevel
triggerall = command = "Poison Claw!"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1  = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2  = var(6)
...
trigger19 = stateno   = 1200 && movecontact
trigger20 = stateno   = 1230 && movecontact
trigger21 = stateno   = 3010 && movecontact
trigger22 = stateno   = 3020 && movecontact
trigger23 = stateno   = 3030 && movecontact
...
[State -1, Whip of Light Ex]
type = ChangeState
value = 1130
triggerall = !AIlevel
triggerall = command = "Whip of Light Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Poison Claw Ex]
type = ChangeState
value = 1030
triggerall = !AIlevel
triggerall = command = "Poison Claw Ex"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Angled Jumping Strong Kick]
type = ChangeState
value = 651
triggerAll = !AILevel
triggerAll = command = "c"
