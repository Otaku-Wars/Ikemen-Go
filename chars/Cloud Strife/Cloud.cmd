...
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="OmniSlash"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Finishing Touch]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="FinishingTouch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max Limit Break Braver]
type=ChangeState
value=3350
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxLimitBreakBraver"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Limit Break Braver]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && stateno!= 3300 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="LimitBreakBraver"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Cross Slash]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxCrossSlash"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Cross Slash]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && stateno!= 3200 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="CrossSlash"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Limit Break Climhazard]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxLimitBreakClimhazard"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Limit Break Climhazard]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && (stateno!= [3100,3101]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="LimitBreakClimhazard"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Meteor Rain]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxMeteorRain"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Air Meteor Rain]
type=ChangeState
value=3075
triggerall=!AILevel && RoundState=2 && StateType = A && Pos y<=-20 &&var(20) <= 60 && power >= 2000&&command ="MaxMeteorRain"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Meteor Rain]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && stateno!= 3000 && !numhelper(3005) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="MeteorRain"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Air Meteor Rain]
type=ChangeState
value=3025
triggerall=!AILevel && RoundState=2 && stateno!= 3025 && !numhelper(3005) && StateType = A && Pos y<=-20 &&var(20) <= 60 && power >= 1000&&command ="MeteorRain"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================
[State -1, Climhazard]
type=ChangeState
value=Ifelse(command="ClimhazardEX"&&var(20) <= 60&&power>=500,1350,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Climhazard1"|command="Climhazard2"|command="Climhazard3")||(command="ClimhazardEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ClimhazardEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, Blade Beam]
type=ChangeState
value=Ifelse(command="BladeBeamEX"&&var(20) <= 60&&power>=500,1050,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<5)
triggerall= ((command="BladeBeam1"|command="BladeBeam2"|command="BladeBeam3")||(command="BladeBeamEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="BladeBeamEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, Sonic Rave]
type=ChangeState
value=Ifelse(command="SonicRaveEX"&&var(20) <= 60&&power>=500,1150,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="SonicRave1"|command="SonicRave2"|command="SonicRave3")||(command="SonicRaveEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="SonicRaveEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, Braver]
type=ChangeState
value=Ifelse(command="BraverEX"&&var(20) <= 60&&power>=500,1250,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Braver1"|command="Braver2"|command="Braver3")||(command="BraverEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="BraverEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, Air Braver]
type=ChangeState
value=Ifelse(command="BraverEX"&&var(20) <= 60&&power>=500,1275,1225)
triggerall=!AILevel && RoundState=2 && StateType = A && Pos Y<=-30 && ((command="Braver1"|command="Braver2"|command="Braver3")||(command="BraverEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl
trigger2=var(5)
...
[State -1, Mad Shift]
type=ChangeState
value=Ifelse(command="MadShiftEX"&&var(20) <= 60&&power>=500,1450,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="MadShift1"|command="MadShift2"|command="MadShift3")||(command="MadShiftEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="MadShiftEX"&&power>=500&&var(20) <= 60)
;========================================================================
...
triggerall = (p2bodydist x = [0, 50])&&(p2bodydist y = [-80,5])&&P2statetype != A&&P2statetype != C&&P2statetype != L&& random < (650 * (AIlevel ** 2 / 64.0))
trigger1 = ctrl
...
triggerall = (p2bodydist x = [0, 70]) && p2statetype != L && !(enemynear, hitfall)
...
value = 220
triggerall = AILevel && numenemy && roundstate=2 && StateType != A
triggerall = (p2bodydist x = [0, 85]) && (p2bodydist y = [ -90, 80]) && p2statetype != L && !(enemynear, hitfall)
...
value = 410
triggerall = AILevel && numenemy && roundstate=2 && StateType != A
triggerall = (p2bodydist x = [0, 75]) &&(p2bodydist y = [-50,25]) && P2statetype != A && P2statetype != L && !(enemynear, hitfall)
trigger1 = ctrl && random < (150 * (AIlevel ** 2 / 64.0))
trigger2 = ((stateno = [200,209])|| (stateno = [230,239])||(stateno = [400,409])||(stateno = [430,439]))&& movehit&&var(55)
trigger2 = random < 800
;---------------------------------------------------------------------------
...
value = 420
triggerall = AILevel && numenemy && roundstate=2 && StateType != A
triggerall = (p2bodydist x = [0, 90]) &&(p2bodydist y = [-80,5]) && P2statetype != L && !(enemynear, hitfall)
...
[State -1, Limit Break Braver]
type=ChangeState
value=Ifelse((power >= 2000 && random < 200), 3350, 3300)
triggerall=AILevel && numenemy && RoundState=2 && stateno!= 3300 && StateType != A &&var(20)<=60 && power >= 1000 && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(p2bodydist x =[40,100])&&(p2bodydist y=[-90,5])&&(enemynear,statetype!=A)&&(enemynear,stateno!=[120,155])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)|| var(7))&&movehit&&random<250
;----------------------------------------------------------------------
[State -1, Cross Slash]
type=ChangeState
value=Ifelse((power >= 2000 && random < 250), 3250, 3200)
triggerall=AILevel && numenemy && RoundState=2 && stateno!= 3200 && StateType != A &&var(20)<=60 && power >= 1000 && random < (300 * (AIlevel ** 2 / 64.0))
...
triggerall=AILevel && numenemy && RoundState=2 && stateno!= 3100 && StateType != A &&var(20)<=60 && power >= 1000 && random < (150 * (AIlevel ** 2 / 64.0))
...
triggerall=(p2bodydist x =[50,200])&&(p2bodydist y=[-100,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)|| var(7))&&movehit&&random<250
;----------------------------------------------------------------------
[State -1, Air Meteor Rain]
type=ChangeState
value=Ifelse((power >= 2000 && random < 100), 3075, 3025)
triggerall=AILevel && numenemy && RoundState=2 && stateno!= 3025 && !numhelper(3005) && StateType = A && pos y<=-20 && var(20) <= 60 && power >= 1000
triggerall=(enemynear,stateno!=[5120,5220])&&(enemynear,stateno!=[120,155]) && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(p2bodydist x =[70,200])&&(p2bodydist y=[-80,155])
trigger1=ctrl
trigger2=(var(6)|| var(7))&&movehit&&random<250
;======================================================================
[State -1, Mad Shift]
type=ChangeState
value=Ifelse((power >= 500 && random < 250), 1450, 1400)
...
[State -1, Climhazard]
type=ChangeState
value=Ifelse((power >= 500 && random < 200), 1350, 1300)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype!=L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[20,75])&&(p2bodydist y=[-110,5])&&(enemynear,statetype!=C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;-------------------------------------------------------------------------
[State -1, Braver]
type=ChangeState
value=Ifelse((power >= 500 && random < 100|power >= 500 && enemynear,statetype=L), 1250, 1200)
...
triggerall=(p2bodydist x =[45,180])&&(p2bodydist y=[-80,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;-------------------------------------------------------------------------
[State -1, Air Braver]
type=ChangeState
value=Ifelse((power >= 500 && random < 100|power >= 500 && enemynear,statetype=L), 1275, 1225)
triggerall=AILevel && numenemy && RoundState=2 && StateType = A && Pos Y<=-30 && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5110,5220])&&(enemynear,stateno!=[120,155])
triggerall=Ifelse(enemynear,Statetype=L,power>=1000,power<1000)
...
[State -1, Sonic Rave]
type=ChangeState
value=Ifelse((power >= 500 && random < 300), 1150, 1100)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
...
triggerall=AILevel && numenemy && RoundState=2 && StateType != A &&(enemynear,statetype!=A) && random < (70 * (AIlevel ** 2 / 64.0))
triggerall=Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<5)
