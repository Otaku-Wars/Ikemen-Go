...
value = 3600
triggerAll = !AILevel
triggerAll = command = "SeperationAnxiety" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Seperation Anxiety]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "SeperationAnxiety" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Maximum Web Ball]
type = ChangeState
value = 3450
triggerAll = !AILevel
triggerAll = command = "MAXMaximumWebBall"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Maximum Assault]
type = ChangeState
value = 3550
triggerAll = !AILevel
triggerAll = command = "MAXCrawlerAssault" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Crawler Assault]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXCrawlerAssault" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Maximum Spider]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXMaximumSpider"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Ultimate Web Throw]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXUltimateWebThrow"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Maximum Web Ball]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "MaximumWebBall"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Maximum Assault]
type = ChangeState
value = 3500
triggerAll = !AILevel
triggerAll = command = "CrawlerAssault" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "CrawlerAssault" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3300 
triggerAll = !AILevel
triggerAll = command = "MaximumSpider"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "UltimateWebThrow"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Spider Kick]
type = ChangeState
value = 1730
triggerAll = !AILevel
triggerAll = command = "EXSpiderKick" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Web Throw]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXWebThrow1" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Web Throw 2]
type = ChangeState
value = 1540
triggerAll = !AILevel
triggerAll = command = "EXWebThrow2" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Web Throw 3]
type = ChangeState
value = 1550
triggerAll = !AILevel
triggerAll = command = "EXWebThrow3" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Spider Sting]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXSpiderSting"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Web Swing]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXWebSwing"
triggerAll = RoundState = 2
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Spider Punch]
type = ChangeState
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXWebBall" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXWebBall" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Air Web Shot]
type = ChangeState
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXWebShot"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
...
value = 1700
triggerAll = !AILevel
triggerAll = command = "SpiderKick" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1500
triggerAll = !AILevel
triggerAll = command = "WebThrow1" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1510
triggerAll = !AILevel
triggerAll = command = "WebThrow2" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1520
triggerAll = !AILevel
triggerAll = command = "WebThrow3" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1400
triggerAll = !AILevel
triggerAll = command = "SpiderSting"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = Stateno != 3303
trigger1 = Stateno != 3304
trigger1 = Stateno != 3305
trigger1 = Stateno != 3310
trigger1 = Stateno != 3315
trigger1 = Stateno != 3320
trigger1 = Stateno != 3325
trigger1 = Stateno != 3330
trigger1 = Stateno != 3331
trigger1 = Stateno != 3350
trigger1 = Stateno != 3351
trigger1 = Stateno != 3352
trigger1 = Stateno != 3353
trigger1 = Stateno != 3354
trigger1 = Stateno != 3355
trigger1 = Stateno != 3360
trigger1 = Stateno != 3365
trigger1 = Stateno != 3370
trigger1 = Stateno != 3375

[State -1, Spider Punch]
type = ChangeState
value = 1600
triggerAll = !AILevel
triggerAll = command = "WebBall" && var(41) != 0
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "WebBall" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Web Shot]
type = ChangeState
value = 1050
triggerAll = !AILevel
triggerAll = command = "WebShot"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
triggerall = NumHelper(1005) = 0
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, Web Throw 2]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100, 1540, 1510)
triggerAll = AILevel && NumEnemy && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerall= p2dist x>=0 && p2bodydist x<=ceil(32 * const(size.xscale)) && p2dist y=0
...
[State -1, Web Throw 3]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100, 1550, 1520)
triggerAll = AILevel && NumEnemy && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerall= p2dist x>=0 && p2bodydist x<=ceil(32 * const(size.xscale)) && p2dist y=0
