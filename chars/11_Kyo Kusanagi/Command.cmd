...
;x + y / x + z / y + z
triggerAll = NumExplod(90000200) && NumExplod(90000230) || NumExplod(90000210) && NumExplod(90000240) || NumExplod(90000220) && NumExplod(90000250)
...
[State -1, Saishu Kessen Ougi "Zero Shiki"]
type = ChangeState
value = 3400
triggerAll = !AILevel
;command = "QCF, QCF"
...
[State -1, MAX Saishu Kessen Ougi "Mu-shiki"/ MAX 182 Shiki]
type = ChangeState
value = 3150 + 400 * (var(40) = 2)
triggerAll = !AILevel
;command = "QCF, QCF"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90030016)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90030114))
;x + y / x + z / y + z
triggerAll = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000205), 1, 0) + ifElse(NumExplod(90000215), 1, 0) + ifElse(NumExplod(90000225), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 2000 && var(20) <= 60 && var(40) != 1
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX 1999 Shiki: Kiri Homura]
type = ChangeState
value = 3350
triggerAll = !AILevel
;command = "QCF, QCF"
...
triggerAll = !AILevel
;command = "QCB, HCF"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90032306)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90032204))
;x + y / x + z / y + z
triggerAll = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000205), 1, 0) + ifElse(NumExplod(90000215), 1, 0) + ifElse(NumExplod(90000225), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
...
[State -1, Saishu Kessen Ougi "Mu-shiki"/ 182 Shiki]
type = ChangeState
value = 3100 + 400 * (var(40) = 2)
triggerAll = !AILevel
;command = "QCF, QCF"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90030016)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90030114))
;x / y / z
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 1000 && var(20) <= 60 && var(40) != 1
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, 1999 Shiki: Kiri Homura]
type = ChangeState
value = 3300
triggerAll = !AILevel
;command = "QCF, QCF"
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 1000 && var(20) <= 60 && var(40) != 2
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
[State -1, EX 101 Shiki: Oboro Guruma (EX Kyo)]
type = ChangeState
value = 1730
triggerAll = !AILevel
;command = "F, D, DF"
...
triggerAll = (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2) || (ifElse(NumExplod(90000235), 1, 0) + ifElse(NumExplod(90000245), 1, 0) + ifElse(NumExplod(90000255), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 500 && var(20) <= 60 && var(40) = 2
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, EX 212 Shiki: Kototsuki Yo / EX 412 Shiki: Hikigane]
type = ChangeState
value = ifElse(var(40) != 2, 1550 + 20 * (var(40) = 1), 1930)
triggerAll = !AILevel
;command = "HCB"
...
triggerAll = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000205), 1, 0) + ifElse(NumExplod(90000215), 1, 0) + ifElse(NumExplod(90000225), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 500 && var(20) <= 60 && var(40) = 0
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000205), 1, 0) + ifElse(NumExplod(90000215), 1, 0) + ifElse(NumExplod(90000225), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 500 && var(20) <= 60 && var(40) = 1
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX 75 Shiki: Kai]
type = ChangeState
value = 1330
triggerAll = !AILevel
;command = "QCF"
...
[State -1, EX 108 Shiki: Yami Barai (Kusanagi)]
type = ChangeState
value = 1630
triggerAll = !AILevel
;command = "QCF"
...
[State -1, EX 108 Shiki: Yami Barai (EX Kyo)]
type = ChangeState
value = 1630
triggerAll = !AILevel
;command = "QCB"
...
;a + b / a + c / b + c
triggerAll = (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2) || (ifElse(NumExplod(90000235), 1, 0) + ifElse(NumExplod(90000245), 1, 0) + ifElse(NumExplod(90000255), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035) && var(40) = 0
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, 101 Shiki: Oboro Guruma (EX Kyo)]
type = ChangeState
value = 1700
triggerAll = !AILevel
;command = "F, D, DF"
...
;a / b / c
triggerAll = NumExplod(90000230) || NumExplod(90000235) || NumExplod(90000240) || NumExplod(90000245) || NumExplod(90000250) || NumExplod(90000255)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035) && var(40) = 2
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, 412 Shiki: Hikigane (HK)]
type = ChangeState
value = 1920
triggerAll = !AILevel && var(40) = 2
;command = "HCB"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90010504)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90010406))
;c
...
[State -1, 412 Shiki: Hikigane (LK/MK)]
type = ChangeState
value = 1900
triggerAll = !AILevel && var(40) = 2
;command = "HCB"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90010504)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90010406))
;a / b
triggerAll = NumExplod(90000230) || NumExplod(90000235) || NumExplod(90000240) || NumExplod(90000245)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, 212 Shiki: Kototsuki Yo / 412 Shiki: Hikigane]
type = ChangeState
value = 1500
triggerAll = !AILevel
;command = "HCB"
...
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90010006)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90010104))
;x / y
triggerAll = NumExplod(90000200) || NumExplod(90000205) || NumExplod(90000210) || NumExplod(90000215)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035) && var(40) != 1
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, 108 Shiki: Yami Barai (Kusanagi)]
type = ChangeState
value = 1600
triggerAll = !AILevel
;command = "QCF"
...
[State -1, 108 Shiki: Yami Barai (EX Kyo)]
type = ChangeState
value = 1600
triggerAll = !AILevel
;command = "QCB"
...
[State -1, Horin/Honofuri (Cancelled)]
type = ChangeState
value = 229 - 2 * (var(40) = 1)
triggerAll = !AILevel
...
[State -1, Horin/Honofuri]
type = ChangeState
value = 228 - 2 * (var(40) = 1)
triggerAll = !AILevel
;command = "holdfwd" && command = "z"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90000006)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000004))
triggerAll = NumExplod(90000220) || command = "z"
...
[State -1, Geshiki: Goufu Yo (Cancelled)]
type = ChangeState
value = 249
triggerAll = !AILevel
;command = "holdfwd" && command = "b"
...
;command = "z" && command = "holddown"
triggerAll = NumExplod(90000002) && (NumExplod(90000220) || command = "z")
triggerAll = StateType = A
trigger1 = ctrl
trigger2 = var(4)
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = P2StateType != L && (P2Dist y = [-80,-40])
triggerAll = (P2BodyDist x = [-35,90])
triggerAll = ((NumTarget(1305) || NumTarget(1330)) && var(11)) || (NumTarget(1831) && var(12))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = P2StateType != L && (P2Dist y = [-110,-85])
...
triggerAll = (P2BodyDist x = [-35,150]) && (P2Dist y = [-120,-105])
triggerAll = ((NumTarget(1305) || NumTarget(1330)) && var(11)) || (NumTarget(1831) && var(12))
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (100 * (AILevel ** 2 / 64.0))
...
trigger1 = (P2BodyDist x = [-20,45]) && (P2Dist y = [-40,80])
trigger1 = ctrl
trigger1 = Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,132]) && (P2Dist y = [-30,0]) && P2StateType != L
...
trigger3 = (var(4) || var(5)) && Random < (50 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,68]) && (P2Dist y = [-30,0]) && P2StateType != L
...
trigger4 = (ctrl || (StateNo = [100,101])) && Random < (500 * (AILevel ** 2 / 64.0))

[State -1, Horin (Canceled)]
type = ChangeState
value = 229
triggerAll = AILevel && NumEnemy && var(40) != 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,52]) && (P2Dist y = [-75,0]) && P2StateType != A && P2StateType != L
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,52]) && (P2Dist y = [-75,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))

[State -1, Honofuri (Canceled)]
type = ChangeState
value = 227
triggerAll = AILevel && NumEnemy && var(40) = 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,126]) && (P2Dist y = [-90,0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = var(5) && Random < (50 * (AILevel ** 2 / 64.0))
trigger1 = (EnemyNear, GetHitVar(HitTime) >= 8)
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,126]) && (P2Dist y = [-90,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (ctrl || (StateNo = [100,101])) && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, StateType = C

[State -1, Geshiki: Goufu Yo (Canceled)]
type = ChangeState
value = 249
triggerAll = AILevel && NumEnemy && var(40) != 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,70]) && (P2Dist y = [-65,0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = var(5) && Random < (50 * (AILevel ** 2 / 64.0))
trigger1 = (EnemyNear, GetHitVar(HitTime) >= 8)
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,70]) && (P2Dist y = [-65,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,118]) && (P2Dist y = [-65,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,62]) && (P2Dist y = [-115,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,85]) && (P2Dist y = [-65,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
...
triggerAll = RoundState = 2 && Statetype != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,55]) && (P2Dist y = [-135,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 4) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,76]) && (P2Dist y = [-35,0]) && P2StateType != A && P2StateType != L
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,35]) && (P2Dist y = [-50,70])
trigger1 = ctrl
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,60]) && (P2Dist y = [-70,50])
trigger1 = ctrl
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,60]) && (P2Dist y = [-70,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,90]) && (P2Dist y = [-20,0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,30]) && (P2Dist y = [-65,55]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y <= 0 && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,45]) && (P2Dist y = [-70,0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,70]) && (P2Dist y = [-30,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,45]) && (P2Dist y = [-40,0]) && P2StateType != A && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 2) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,36]) && (P2Dist y = [-50,65]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y <= 0 && Random < (100 * (AIlevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,32]) && (P2Dist y = [-90,80]) && P2StateType != L
trigger1 = ctrl
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,32]) && (P2Dist y = [-30,65]) && P2StateType != L
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (ifElse(P2Dist x < 0, 250, 50) * (AILevel ** 2 / 64.0))
...
triggerAll = ((P2BodyDist x = [-50,50]) && P2StateType != A) || ((P2BodyDist x = [-5,65]) && P2StateType = A)
...
[State -1, Hikigane]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133 && var(20) <= 60, 1930, ifElse(P2BodyDist x < 40, 1920, 1900))
triggerAll = AILevel && NumEnemy && var(40) = 2
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-120,0])
triggerAll = ((P2BodyDist x = [0,130]) && P2StateType != A) || ((P2BodyDist x = [-35,100]) && P2StateType = A)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = ((P2BodyDist x = [-30,120]) && P2StateType != A) || ((P2BodyDist x = [-5,120]) && P2StateType = A)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
...
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2BodyDist x >= 75 && P2Dist y >= -120 && EnemyNear, vel y >= 0
...
[State -1, R.E.D. Kick]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && var(20) <= 60, 1430, 1400)
triggerAll = AILevel && NumEnemy && var(40) != 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && var(20) <= 60, 1730, 1700)
triggerAll = AILevel && NumEnemy && var(40)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (EnemyNear, MoveType != A) || (EnemyNear, StateNo = [200, 499])
triggerAll = (P2BodyDist x = [-8,75]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
...
[State -1, Aragami / Dokugami]
type = ChangeState
value = ifElse(Random < 500, 1100, 1000)
triggerAll = AILevel && NumEnemy && var(40) != 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-8,140]) && (P2Dist y = [-75,0]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger1 = P2BodyDist x >= 25 && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 6

[State -1, Dokugami Kai]
type = ChangeState
value = 1150
triggerAll = AILevel && NumEnemy && var(40) != 1
triggerAll = Power >= 500 && var(20) <= 60
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-8,170]) && (P2Dist y = [-75,0]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger1 = P2BodyDist x >= 25 && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 6
...
[State -1, Aoki]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && var(20) <= 60, 1830, 1800)
triggerAll = AILevel && NumEnemy && var(40) = 1
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = (EnemyNear, MoveType != A) || (EnemyNear, StateNo = [200,499])
triggerAll = (P2BodyDist x = [-8,115]) && (P2Dist y = [-55,0]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 6

[State -1, Kototsuki Yo]
type = ChangeState
value = ifElse(Power >= 500 && (P2BodyDist x = [0,135]) && var(40) != 1 && Random < 100 && var(20) <= 60, 1550, 1500)
triggerAll = AILevel && NumEnemy && var(40) != 2
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = (EnemyNear, MoveType != A) || (EnemyNear, StateNo = [200,499])
...
[State -1, EX Kototsuki Yo (Kusanagi)]
type = ChangeState
value = 1570
triggerAll = AILevel && NumEnemy && var(40) = 1
triggerAll = power >= 500 && var(20) <= 60
...
triggerAll = P2Dist x >= 0 && P2Dist x <= 60 && P2Dist y = 0
...
[State -1, MAX Mu-Shiki/Kiri Homura/182 Shiki]
type = ChangeState
value = ifElse(!var(40), 3150, ifElse(var(40) = 1, 3350, 3550))
triggerAll = AILevel && NumEnemy && var(40)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 2000 && var(20) <= 60
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = ifElse(!var(40), (P2BodyDist x = [0,135]), ifElse(var(40) = 1, (P2BodyDist x = [0,125]), (P2BodyDist x = [0,110])))
triggerAll = (P2Dist y = [-50,0]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))
...
[State -1, Mu-Shiki/Kiri Homura/182 Shiki]
type = ChangeState
value = ifElse(!var(40), 3100, ifElse(var(40) = 1, 3300, 3500))
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = Power >= 1000 && var(20) <= 60
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
