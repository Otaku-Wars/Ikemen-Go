...
;----------------------------------------------------------------------
[State -1, Max Guts virotes]
type=ChangeState
value=3550
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3051]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Guts virotes"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)

;----------------------------------------------------------------------
[State -1, Guts virotes]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3101]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Guts virotes"
...
value = 1150
triggerall =  !AILevel && roundstate=2 && statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Ougi Kogetsu Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
...
value = 1100
triggerall =  !AILevel && roundstate=2 && statetype!=A
triggerall = command = "Ougi Kogetsu Zan" 
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-------------------------------------------------------------------------
