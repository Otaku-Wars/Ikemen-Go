...
[State -1, Superman Justice]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "SupermanJustice"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Super Punch]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXSuperPunch"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Speed Fury]
type = ChangeState
value = 3750
triggerAll = !AILevel
triggerAll = command = "MAXSpeedFury"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Super Tsunami]
type = ChangeState
value = 3650
triggerAll = !AILevel
triggerAll = command = "MAXSuperTsunami"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Super Ground Breaker]
type = ChangeState
value = 3550
triggerAll = !AILevel
triggerAll = command = "MAXSuperGroundBreaker"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Hyper Fly Assault]
type = ChangeState
value = 3450
triggerAll = !AILevel
triggerAll = command = "MAXSpeedFury"
...
[State -1, MAX No Mercy]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXNoMercy"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 3700
triggerAll = !AILevel
triggerAll = command = "SpeedFury"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Super Tsunami]
type = ChangeState
value = 3600
triggerAll = !AILevel
triggerAll = command = "SuperTsunami"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Super Ground Breaker]
type = ChangeState
value = 3500
triggerAll = !AILevel
triggerAll = command = "SuperGroundBreaker"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Hyper Fly Assault]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "SpeedFury"
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "NoMercy"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Air Fly Assault]
type = ChangeState
value = 1680
triggerAll = !AILevel
triggerAll = command = "EXFlyAssault"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Fly Assault]
type = ChangeState
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXFlyAssault"
...
[State -1, EX Slide Kick]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXSlideKick"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Air Flight Attack]
type = ChangeState
value = 1580
triggerAll = !AILevel
triggerAll = command = "EXFlightAttack"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Flight Attack]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXFlightAttack"
...
[State -1, EX Angled Air Laser Vision]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXIceBreath"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Drill Punch]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXDrillPunch"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Air Laser Vision]
type = ChangeState
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXLaserVision"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, Air Fly Assault]
type = ChangeState
value = 1650
triggerAll = !AILevel
triggerAll = command = "FlyAssault"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Air Flight Attack]
type = ChangeState
value = 1550
triggerAll = !AILevel
triggerAll = command = "FlightAttack"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Flight Attack]
type = ChangeState
value = 1500
triggerAll = !AILevel
triggerAll = command = "FlightAttack"
...
[State -1, Angled Air Laser Vision]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "IceBreath"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "DrillPunch"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Laser Vision]
type = ChangeState
value = 1050
triggerAll = !AILevel
triggerAll = command = "LaserVision"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Laser Vision]
type = ChangeState
value = 1000
triggerAll = !AILevel
triggerAll = command = "LaserVision"
...
[State -1, Air Flight Attack]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133, 1580, 1550)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
